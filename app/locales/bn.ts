 ...
 `,
  ...
  Chat: {
    ...
    InputActions: {
      ...
      Optimize: "প্রম্পট অপ্টিমাইজ করুন",
      OptimizeToast: "✨ আপনার প্রম্পট অপ্টিমাইজ করা হচ্ছে...",
      OptimizeSuccess: "✅ প্রম্পট অপ্টিমাইজ করা হয়েছে",
      OptimizeError: "❌ অপ্টিমাইজেশন ব্যর্থ হয়েছে, আবার চেষ্টা করুন",
