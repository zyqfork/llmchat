 ...
 `,
  ...
  Chat: {
    ...
    InputActions: {
      ...
      Masks: "Все маски",
      Clear: "Очистить чат",
      Optimize: "Оптимизировать запрос",
      OptimizeToast: "✨ Оптимизация вашего запроса...",
      OptimizeSuccess: "✅ Запрос оптимизирован",
      OptimizeError: "❌ Ошибка оптимизации, попробуйте еще раз",
  ...
  Settings: {
    ...
    OptimizeModel: {
      Title: "Модель оптимизации запросов",
      SubTitle:
        "Модель, используемая для оптимизации пользовательских запросов. Если не настроена, используется текущая модель чата",
    },
    Temperature: {
